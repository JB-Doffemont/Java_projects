...
public class Main {
    ...
    public static void main(String[] args) {
         ...
         * Repository Pattern: Teste l'ajout et la récupération des livres via
         * LivreRepository.
         * Lazy Loading: Charge les détails de la commande uniquement lorsque
         * nécessaire.
         * Strategy Pattern: Calcule les frais de port en utilisant une stratégie
         * spécifique.
         * State Pattern: Change l'état d'une commande et vérifie le nouvel état.
         * Adapter Pattern: Intègre un service de notification externe (ici représenté
         * par EmailService).
         * 
         * Vous ne devez pas modifier ce fichier pour réaliser le TP (sauf pour
         * commenter/décommenter des parties pour tester)
         *********************************************************************************************************/
        ...
        // Affichage attendu : État de la commande après passage à l'état suivant :  Commande en cours
        commande.etatSuivant();
        System.out.println("État de la commande après passage à l'état suivant : " + commande.getStatus());
        ...
        // Dans la pratique, EmailService est une bibliothèque externe que vous voulez
        // adapter,
